...
namespace image {
    ...
    // load and store
    template <class T> int load(image::rgba<T> *rgba, float *data, int w, int h);
	template <class T> int load(image::rgba<T> *rgba, float *data, int w, int h,int rowstride,float min,float max);
    template <class T> int store(float *data, const image::rgba<T> &rgba);
	template <class T> int store_gray(float *data, const image::rgba<T> &rgba);
	template <class T> int store(float *data, const image::rgba<T> &rgba,int rowstride,float min,float max);
